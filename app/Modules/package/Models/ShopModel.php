...
class ShopModel extends Model
{
    ...
    //
    protected $fillable = [
        'id', 'uid', 'type', 'shop_pic', 'shop_name', 'shop_desc','province','city','area','status','created_at','updated_at','shop_bg',
        'seo_title','seo_keyword','seo_desc', 'is_recommend','phone','email','openWeb','service_company','reason'
    ];
